...
class TestFailureScenarios:
    ...
    def test_invalid_api_key_causes_exception(self):
        ...
        generator = AIGenerator(api_key="invalid_key_12345", model="claude-sonnet-4-20250514")
    ...
    def test_empty_ai_response_returns_fallback(self):
        ...
        from ai_generator import AIGenerator
        from test_data.mock_responses import create_tool_use_response, create_empty_response
    ...
    def test_course_name_resolution_failure(self):
        ...
        mock_store = Mock()
        mock_store.search.return_value = SearchResults.empty("No course found matching 'NonExistent'")
    ...
    def test_network_error_to_anthropic_api(self):
        ...
        mock_client = Mock()
        mock_client.messages.create.side_effect = Exception("Network error: Connection timeout")
    ...
    def test_full_pipeline_with_api_error(self):
        ...
        with patch('rag_system.VectorStore'), \
            ...
            mock_ai_instance = Mock()
            mock_ai_instance.generate_response.side_effect = Exception("API Error: Invalid key")
            mock_ai.return_value = mock_ai_instance
